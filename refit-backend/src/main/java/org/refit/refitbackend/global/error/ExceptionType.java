...
public enum ExceptionType {
    ...
    CHAT_REQUEST_TYPE_INVALID(HttpStatus.BAD_REQUEST, "CHAT_REQUEST_TYPE_INVALID", "요청 타입은 FEEDBACK 또는 COFFEE_CHAT이어야 합니다."),
    CHAT_FEEDBACK_CONTEXT_REQUIRED(HttpStatus.BAD_REQUEST, "CHAT_FEEDBACK_CONTEXT_REQUIRED", "피드백 요청은 이력서와 공고 링크가 모두 필요합니다."),
    ...
    CHAT_JOB_POST_URL_INVALID(HttpStatus.BAD_REQUEST, "CHAT_JOB_POST_URL_INVALID", "공고 링크는 http:// 또는 https:// 형식이어야 합니다."),
    CHAT_ROOM_STATUS_INVALID(HttpStatus.BAD_REQUEST, "CHAT_ROOM_STATUS_INVALID", "채팅방 상태는 ACTIVE 또는 CLOSED여야 합니다."),
    ...
    CHAT_REQUEST_ALREADY_EXISTS(HttpStatus.CONFLICT, "CHAT_REQUEST_ALREADY_EXISTS", "처리 대기 중인 채팅 요청이 이미 존재합니다."),
